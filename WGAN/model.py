...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv_bolok5 = self.__conv_block(channels[4], channels[5], kernel_size, stride, padding)
        self.conv_bolok6 = self.__conv_block(channels[5], 1, kernel_size-1, stride-1, 0, "last_layer") 
